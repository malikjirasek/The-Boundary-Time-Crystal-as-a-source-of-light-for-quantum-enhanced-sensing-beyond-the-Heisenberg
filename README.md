...
- Navigate to the desired directory and run scripts
    ```sh
    path-to-repo/.venv/bin/python path-to-repo/Fig-xx/script.py

4. **Run the notebooks for plotting:**
- Navigate to the desired directory and start Jupyter
    ```sh
    jupyter notebook

## Dependencies
- Dependencies are listed in the requirements.txt and can be installed using
    ```sh
    pip install -r /path/to/requirements.txt

## Contact 

For questions or collaboration, please contact the repository owner via malik.jirasek@student.uni-tuebingen.de .